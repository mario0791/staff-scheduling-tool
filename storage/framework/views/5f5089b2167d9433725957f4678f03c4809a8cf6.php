        ...
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="updateAvatar" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                ...
                <div class="app-modal-body">
                    ...
                    <?php else: ?>
                        <div class="avatar av-l upload-avatar-preview" style="background-image: url('<?php echo e(asset('/storage/'.config('chatify.user_avatar.folder').'avatars/avatar.png')); ?>');"></div>
                    <?php endif; ?>
...
<?php /**PATH /home/sites/1a/7/74fc9abc3b/public_html/resources/views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>