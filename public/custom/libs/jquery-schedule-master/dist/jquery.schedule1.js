  ...
  $.extend(Plugin.prototype, {
    ...
    create: function () {
      ...
      for (var i = 0; i < this.settings.days; i++) {
        $('<td><div class="jqs-day" data-days="'+i+'"></div></td>').
    ...
    add: function (parent, position, height, options) {
      ...
      var periodTime = '<div class="jqs-period-time" data-time="' + this.periodInit(position, position + height) + '">' + this.periodInit(position, position + height) + '</div>';
      var periodTimeinput = '<div class="schedule_avaabilty_input"><input type="text" class="jqs-period-time jqs-period-time-text w-100" value="'+this.periodInit(position, position + height)+'"><input type="text" class="jqs-period-time jqs-period-days-text w-100"  value=""><input type="text" class="jqs-period-time jqs-period-availability-text w-100" style="border:1px solid #000" value="'+availability+'"></div>';
      ...
      //console.log('jqs-period-availability-text',$(period).find('.jqs-period-container .schedule_avaabilty_input').hasClass('jqs-period-availability-text'));
      //console.log($(period).find('.jqs-period-container .schedule_avaabilty_input').html());
