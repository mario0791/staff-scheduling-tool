...
;(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    ...
    create: function () {
      ...
      $('<table class="jqs-table"><tr class="dayhead"></tr><tr class="daybody"></tr></table>').appendTo($(this.element));

      for (var i = 0; i < this.settings.days; i++) {
        $('<td><div class="jqs-day" data_days="'+i+'"></div></td>').
          appendTo($('.jqs-table .daybody', this.element));
      }

      $('<div class="jqs-grid"><div class="jqs-grid-head"></div></div>').appendTo($(this.element));
      $('<div class="jqs-grid-line"><div class="jqs-grid-hour"></div></div>').
      ...
      for (var k = 0; k < this.settings.days; k++) {
        $('<td>' + this.settings.daysList[k] + dayRemove + dayDuplicate + '</td>').
          appendTo($('.jqs-table .dayhead', this.element));
      }
    },
    ...
    add: function (parent, position, height, options) {      
      ...
      //console.log(day_no);
      //name =  timetable['+data_days+']['+countetr+'][time]
