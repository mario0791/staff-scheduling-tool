...
{{ Form::model($contract, array('route' => array('contract.copydata', $contract->id), 'method' => 'any')) }}
<div class="row">
    ...
    <div class="form-group col-md-12">
     ...
     {{-- <div class="form-group col-md-6">
        ...
        <div class="custom-control custom-radio d-inline-block ">
            ...
            <input type="radio" name="status" value="1" class="form-check-input" {{($contract->status == '1') ? 'checked':'' }}>
            <label class="custom-label text-dark">{{ __('Start') }}</label>
        </div>

        <div class=" custom-control custom-radio d-inline-block mx-5">
            <input type="radio" name="status" value="0"
                class="form-check-input" {{($contract->status == '0') ? 'checked':'' }} >
            <label class="custom-label text-dark">{{ __('Close') }}</label>
        </div>
    </div> --}}
</div>
<div class="row">
