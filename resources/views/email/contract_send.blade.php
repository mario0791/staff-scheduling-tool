                                                                     ...
                                                                     <tbody>
                                                                        <tr>
                                                                           <td style="width:110px">
                                                                              <img alt="" height="auto" src="{{ $dir.'/'. 'logo.png'  }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%" title="" width="110" class="CToWUd">
                                                                           </td>
                                                                        </tr>
                                                                     </tbody>
                                                                  </table>
                                                      ...
                                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top" width="100%">
                                                         <tbody>
                                                            ...
                                                            <tr>
                                                               <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word">
                                                                  <div style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82">
                                                                     <p style="margin:10px 0;text-align:center">{{__('Hi  '.$employee->first_name.',  Thank you for joining to RotaGo in Contract as a User')}}</p>
                                                                     <p style="margin:10px 0;text-align:center">{{__('Your Contact Details')}}:</p>
                                                                  </div>
                                                               </td>
                                                            </tr>
                                                            <tr>
                                                               <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word">
                                                                  <div style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82">
                                                                     <p style="margin:10px 0 0 0;line-height:22px; text-align:center"><b>{{__('Contract Name')}} : </b>{{ $contract->contract_name }}</p> 

                                                                     <p style="margin:10px 0 0 0;line-height:22px; text-align:center"><b>{{__('Contract Subject')}} : </b>{{ $contract->subject }}</p>                                                                     
                                                                      <p style="margin:0px 0 0 0; line-height:22px; text-align:center"><b>{{__('Value')}} : </b>{{ $contract->value }}</p>

                                                                     <p style="margin:0px 0 0 0; line-height:22px; text-align:center"><b>{{__('Contract Start Date')}} : </b> {{ $contract->start_date }}</p>

                                                                     <p style="margin:0px 0 0 0; line-height:22px; text-align:center"><b>{{__('Contract End Date')}} : </b> {{ $contract->end_date }}</p>
                                                            ...
                                                            <tr> 
                                                               <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word">
                                                                  <div style="font-family:Open Sans,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82">
                                                                     <p style="margin:10px 0;text-align:center">{{__('If there is anything that feels unclear or needs to change, please share your feedback with me.')}}
                                                                     </p>
                                                                     <p style="margin:10px 0;"> {{__('I am looking forward to hearing from you soon!')}} </p>
                                                                     <p style="margin:10px 0;">  {{__('Thanks,')}} </p>
